...
namespace PrograB3Project.Components
{
    internal class ShopComponent : KeyLocationComponent
    {
        ...
        public ShopComponent(Interfaces.IGameObject owner, IGameEngine engine, IEventManager event_manager,LocationComponent owner_location,TradingComponent trading_comp, InventoryComponent shop_inventory_comp, RenderManager render_manager,CollisionComponent collision_component,TransformComponent owner_transform) : base(owner, event_manager,owner_location,render_manager, collision_component, owner_transform)
        {
